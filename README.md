...
## Usage
```JavaScript
const createSitemap = SitemapGenerator({
  crawlerMaxDepth: 0,
...
const generator = createSitemap('https://larsgraubner.com', stats => {
  console.log(stats)
})
...
Creates an sitemap generator instance with specified options.
...
Beside the options mentioned above you can override the options used by the underlying crawler. Read 
more about them on the [official package readme](https://github.com/simplecrawler/simplecrawler#configuration).
